          ...
          <form class="form-horizontal" id="formCredits" method="post" action="reqCredits.php">
			  ...
			  <label for="card" class="col-sm-2 control-label">Tarjeta</label>
				<div class="col-sm-10">
					<select class="selectpicker" id="card" name="card" required >
						<option id="0" disabled="disabled" <?php if (!isset($_POST['card'])){?>selected<?php }?>> Seleccion&aacute; </option>
						<option id="V" <?php if (isset($_POST['card']) && ($_POST['card']=='VISA')){?>selected<?php }?>>VISA</option>
						<option id="M" <?php if (isset($_POST['card']) && ($_POST['card']=='MASTERCARD')){?>selected<?php }?>>MASTERCARD</option>
					</select>
			  	</div>
			</div>
            ...
            <div class="form-group cardOwner">
			  <label for="titCard" class="col-sm-2 control-label">Titular</label>
              	<div class="col-sm-10">
					<input type="text" class="form-control" id="titCard" name="titCard" placeholder="Titular de la tarjeta" <?php if (isset($_POST['titCard'])){?>value="<?php echo $_POST['titCard']; ?>"<?php }?> required />
                </div>
            </div>
            <!-- Número -->
            <div class="form-group cardNumber">
			  <label for="numCard" class="col-sm-2 control-label">N&uacute;mero</label>
              	<div class="col-sm-10">
					<input type="text" class="form-control" id="numCard" name="numCard" placeholder="N&uacute;meros del frente de la tarjeta" size="16" <?php if (isset($_POST['numCard'])){?>value="<?php echo $_POST['numCard']; ?>"<?php }?> required />
                </div>
            </div>
            <!-- Fecha de Emisión -->
              	...
              	<div class="col-sm-10">
					<input type="date" class="form-control dateSelector" id="cardE" name="cardE" 
							data-provide="datepicker" data-date-format="mm/yy" 
                           	...
                           	<?php if (isset($_POST['cardE'])){?>value="<?php echo $_POST['cardE']; ?>"<?php }?> required />
                </div>
            </div>
              	...
              	<div class="col-sm-10">
					<input type="date" class="form-control dateSelector" id="cardV" name="cardV" 
							data-provide="datepicker" data-date-format="mm/yy" 
                           	...
                           	<?php if (isset($_POST['cardV'])){?>value="<?php echo $_POST['cardV']; ?>"<?php }?> required />
                </div>
            </div>
            <script type="text/javascript">
            ...
            <div class="form-group securityCode">
			  <label for="codCard" class="col-sm-2 control-label">C&oacute;digo</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" id="codCard" name="codCard" placeholder="Tres d&iacute;gitos del dorso de la tarjeta" size="3" <?php if (isset($_POST['codCard'])){?>value="<?php echo $_POST['codCard']; ?>"<?php }?> required />
                </div>
            </div>
